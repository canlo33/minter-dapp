...
const namePrefix = "HUS Sep 22";
const description = "Trial Minted On Sep 22";
...
const GENERIC_DESCRIPTION = "HUS Sep 22 Pre Reveal Description"; // Replace with what you want the generic descriptions to say.
